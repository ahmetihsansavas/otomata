   ...
   let i= identifier();
    ...
    while (tok == COMMA)  {
       ...
       if (tok == ASSIGN) {
         let deger = withValue();
            L.pop();
             console.log(new Assignment(a,deger));
             L.push(new Assignment(a,deger));
    ...
    let deger = withValue();
         L.pop();
        console.log(new Assignment(i,deger));
        L.push(new Assignment(i,deger));
